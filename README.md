...
<p align="center">
  <img src="https://img.shields.io/github/v/release/fishboii21/nomex-shift?display_name=tag&sort=semver&style=flat-square&color=1683ff&label=release" alt="Latest release">
  <img src="https://img.shields.io/badge/platform-Windows%2010%20%7C%2011-1683ff?style=flat-square" alt="Windows 10 and 11">
  <img src="https://img.shields.io/github/downloads/fishboii21/nomex-shift/total?style=flat-square&color=1683ff&label=downloads" alt="GitHub release downloads">
  <img src="https://img.shields.io/github/actions/workflow/status/fishboii21/nomex-shift/validate-repository.yml?style=flat-square&label=release%20validation" alt="Release validation">
...
<p align="center">
  <a href="https://github.com/fishboii21/nomex-shift/releases/latest/download/NomexShift-Setup.exe"><img src="https://img.shields.io/badge/DOWNLOAD%20NOMEX%20SHIFT-WINDOWS%20INSTALLER-1683ff?style=for-the-badge&logo=windows&logoColor=white" alt="Download Nomex Shift"></a>
</p>
...
The current public product version is **2.3.0**. Release qualification should be completed on clean Windows 10 and Windows 11 systems before publication.

## Install

1. Open the [latest release](https://github.com/fishboii21/nomex-shift/releases/latest).
...
See [CHANGELOG.md](CHANGELOG.md) for product history and the [Releases page](https://github.com/fishboii21/nomex-shift/releases) for installers, checksums, release notes, and known issues.
...
<p align="center"><img src="assets/nomex-rocket-n.png" alt="Nomex rocket-shaped N" width="72"><br><a href="https://github.com/fishboii21/nomex-shift">Nomex home</a> · <a href="https://github.com/fishboii21/nomex-shift/tree/main/legal">Legal index</a><br><sub>© 2026 Nomex. Original Nomex materials are proprietary.</sub></p>
